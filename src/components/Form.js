...
export const Form = ({editFormVisiblity, editTodo, cancelUpdate}) => {
            ...
            {editFormVisiblity===false ? (
                <form className="form-group custom-form" onSubmit={handleSubmit}>
                    ...
                    <div className="input-and-btn">
                        ...
                        <button type="submit" className="btn btn-secondary btn-nd">ADD</button>
                    </div>
                </form>
            ) : (
                <form className="form-group custom-form" onSubmit={editSubmit}>
                    ...
                    <div className="input-and-btn">
                        ...
                        />
                        <button type="submit" className="btn btn-secondary btn-nd">UPDATE</button>
                    </div>
